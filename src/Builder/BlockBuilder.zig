...
pub fn op(self: *BlockBuilder, comptime code: Core.Op.Code, data: anytype) Error!void {
...
pub fn exitOp(self: *BlockBuilder, comptime code: Core.Op.Code, data: anytype) Error!void {
